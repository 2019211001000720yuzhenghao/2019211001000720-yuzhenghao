        ...
        <div class="table-responsive col-sm-10">
            <table class="table table-condensed">
                ...
                <tr>
                    ...
                    <td>order Date</td>
                    <%
                        com.YuZhenghao.model.Order o=(com.YuZhenghao.model.Order)pageContext.findAttribute("o");
                        int userId=o.getCustomerId();
                        java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
                        com.YuZhenghao.dao.UserDao userDao=new com.YuZhenghao.dao.UserDao();
                    ...
                    <td class="cart_total">
                        <%
                            ...
                            String paymentType=com.YuZhenghao.model.Payment.findByPaymentId(con,n);
                        %>
